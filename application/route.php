...
Route::get('/rencent','index/index/rencent');
//获取Banner
...
Route::get('index/category/:id/:index','index/category/getOneCategoryProducts');

Route::get('index/category/sell','index/category/productsByCategoryAndSell');
Route::get('index/category/priceUp','index/category/productsByCategoryAndPriceUp');
Route::get('index/category/priceDown','index/category/productsByCategoryAndPriceDown');

//用户评论
Route::post('user/comment','index/user/goComment');

//获取用户数据
Route::get('personal/changeBase','index/User/changeBase');
Route::get('personal/changePassword','index/User/changePassword');
Route::get('personal/changeAvatar','index/User/changeAvatar');

//修改用户数据
Route::post('personal/saveChangeBaseMessage','index/User/saveChangeBaseMessage');
Route::post('personal/saveChangePassword','index/User/saveChangePassword');
Route::post('personal/saveChangeAvatar','index/User/uploadAvatar');
...
Route::get('index/informs','index/message/listen');
Route::get('index/messages','index/message/messages');
Route::get('message/read','index/message/read');